...
public class Familiar extends Usuario {
    ...
    public Familiar(String usuario, String nombre, String apellidos, String email, String telMovil, String telFijo, String localidad, String pais, String direccion) {
